...
- (void)viewDidLoad {
    ...
    [_doneButton addTarget:self action:_canDelete ? @selector(deleteButtonPressed:) :@selector(doneButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
    ...
    if(!_doneButtonImage) {
        ...
        if (_canDelete) {
            [_doneButton setTitle:@"Delete" forState:UIControlStateNormal];
        }else{
